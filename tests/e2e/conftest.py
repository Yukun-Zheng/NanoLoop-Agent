...
def small_image_dims() -> dict[str, int]:
    """Small image (512x512) — typical for quick previews."""
    return {"width": 512, "height": 512}


@pytest.fixture
def large_image_dims() -> dict[str, int]:
    """Large SEM image (4096x4096) — tests tiling/downscaling behaviour."""
    return {"width": 4096, "height": 4096}


@pytest.fixture
def portrait_image_dims() -> dict[str, int]:
    """Portrait image (2048x1024) — tests non-square aspect ratio."""
