...
class TestCanvasChangeParsing:
    ...
    def test_parse_empty_boxes(self) -> None:
        ...
        change = parse_canvas_change({"event_id": "evt_002", "boxes": []}, max_boxes=10)
        assert change is not None
    ...
    def test_max_boxes_enforced(self) -> None:
        ...
        boxes = [{"x1": i * 10, "y1": 0, "x2": i * 10 + 5, "y2": 5} for i in range(50)]
        with pytest.raises(ValueError, match="At most"):
            parse_canvas_change({"event_id": "evt_003", "boxes": boxes}, max_boxes=5)
