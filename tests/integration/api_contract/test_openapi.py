...
def test_openapi_contains_the_frozen_v1_surface(api_harness: ApiHarness) -> None:
    ...
    expected_operations = {
        ...
        ("/api/v1/analyses/{job_id}/agent-tasks", "post"),
        ("/api/v1/analyses/{job_id}/agent-tasks", "get"),
        ("/api/v1/agent-tasks/{task_id}", "get"),
        ("/api/v1/agent-tasks/{task_id}/run", "post"),
        ("/api/v1/agent-tasks/{task_id}/input", "post"),
        (
            "/api/v1/agent-tasks/{task_id}/approvals/{approval_id}",
            "post",
        ),
        ("/api/v1/agent-tasks/{task_id}/cancel", "post"),
